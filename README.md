...
- MERGE PARZIALE: aggiungere solo dei file specifici [PATH] dal proprio branch [NOME_BRANCH] al branch master: 2 COMANDI: git checkout master 
															  git checkout [NOME_BRANCH] [PATH]
