...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        EdgeDao.createTable(db, ifNotExists);
        NodeDao.createTable(db, ifNotExists);
        MapsDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        EdgeDao.dropTable(db, ifExists);
        NodeDao.dropTable(db, ifExists);
        MapsDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(EdgeDao.class);
        registerDaoClass(NodeDao.class);
        registerDaoClass(MapsDao.class);
